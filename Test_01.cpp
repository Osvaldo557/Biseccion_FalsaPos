...
float Biseccion(float x_upper, float x_lower, float error_permitido,bool &terminado){
...
int main(){
	...
	float raiz = Biseccion(2.0,0.0,0.01,terminado);

	if (terminado == true){
		printf("El estado del programa es: %d",terminado);
